...
class BattlePage extends Component {
  ...
  //   }
    const userWinCount=this.state.winCount
    Axios.post("/gamestate", (req, res) => {
      User.findOneAndUpdate( { username: req.body.username }, {winCount:userWinCount }).then(user => {
              console.log(user);
              if (!user) {
  ...
  //get the deck//get the wincount//post the wincount//post the newcards
